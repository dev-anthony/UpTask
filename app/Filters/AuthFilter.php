...
class AuthFilter implements FilterInterface
{
  ...
  public function before(RequestInterface $request, $arguments = null)
  {
    ...
    try {
      ...
      return Services::response()->setStatusCode(ResponseInterface::HTTP_INTERNAL_SERVER_ERROR)->setBody(json_encode(['error' => 'Ocurrió un error en el servidor al validar el token']));
    }
  }
